...
public class PipeHandler : MonoBehaviour
{
   ...
   private void SpawnNewPipes() {
       ...
       Pipe topPipe = Instantiate(pipePrefab, transform.position, Quaternion.Euler(-90f, 0f, 0f));
       Pipe bottomPipe = Instantiate(pipePrefab, transform.position, Quaternion.Euler(90f, 0f, 0f));
